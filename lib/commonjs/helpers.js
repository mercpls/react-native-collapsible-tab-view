...
const { isRTL } = _reactNative.I18nManager
exports.isRTL = isRTL
const IS_IOS = _reactNative.Platform.OS === 'ios'
exports.IS_IOS = IS_IOS

const AnimatedFlatList = _reactNativeReanimated.default.createAnimatedComponent(
  _reactNative.FlatList
)

exports.AnimatedFlatList = AnimatedFlatList

const AnimatedSectionList = _reactNativeReanimated.default.createAnimatedComponent(
...
function makeRenderFunction(ComponentOrMemo) {
  return typeof ComponentOrMemo === 'function'
    ...
    ? (props) =>
        /*#__PURE__*/ _react.default.createElement(ComponentOrMemo, props)
    : undefined
}
