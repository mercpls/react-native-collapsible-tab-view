...
export const Container = /*#__PURE__*/React.memo( /*#__PURE__*/React.forwardRef(({
  ...
  const scrollX = useSharedValue(index.value * width);
  const pagerOpacity = useSharedValue(initialHeaderHeight === undefined || index.value !== 0 ? 0 : 1);
  ...
  }, [containerRef, initialTabName, width]); // the purpose of this is to scroll to the proper position if dynamic tabs are changing
  ...
  useAnimatedReaction(() => {
    ...
    if (trigger) {
      ...
      tabNamesArray.forEach(name => {
        ...
        scrollToImpl(refMap[name], 0, scrollY.value[index.value] - contentInset.value, false);
      });
  ...
  return /*#__PURE__*/React.createElement(Context.Provider, {
    ...
    onTabPress,
    tabProps
  }))), headerHeight !== undefined && /*#__PURE__*/React.createElement(AnimatedFlatList, _extends({
    ref: containerRef,
