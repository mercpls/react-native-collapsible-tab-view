...
import { FlatList, FlatListProps as RNFlatListProps, ScrollView, SectionList, StyleProp, ViewStyle } from 'react-native';
...
export declare type CollapsibleProps = {
     ...
     */
    HeaderComponent?: ((props: TabBarProps<TabName>) => React.ReactElement) | React.MemoExoticComponent<(props: TabBarProps<TabName>) => React.ReactElement> | null;
    /**
     * @obsolete use `renderTabBar` instead. This property will be removed in 5.0.0
     */
    TabBarComponent?: ((props: TabBarProps<TabName>) => React.ReactElement) | React.MemoExoticComponent<(props: TabBarProps<TabName>) => React.ReactElement> | null;
